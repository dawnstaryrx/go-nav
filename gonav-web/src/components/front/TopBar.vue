  ...
  <div class="header-navbar-container">
    ...
    <div class="container-fluid header-navbar-top-content">
      <div class="d-flex align-items-center">
        ...
        <!-- <a class="navbar-brand ms-2 noto-serif-sc-brand" href="/">Go导航</a> -->
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item header-navbar-top-item">
            <!-- <a class="nav-link noto-serif-sc-text" aria-current="page" href="/hello">Go导航</a> -->
