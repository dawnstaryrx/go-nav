    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary header-navbar-top">
      <div class="container-fluid header-navbar-top-content">
        <div class="d-flex align-items-center">
          ...
          <router-link class="navbar-brand ms-2 noto-serif-sc-brand"  to="/manage/index">Go导航管理端</router-link>
        </div>
        ...
        <ul class="navbar-nav ms-auto d-none d-lg-flex">
          ...
          <li v-if="!nowUser.role || nowUser.role && nowUser.role === 0" class="nav-item header-navbar-top-icon">
